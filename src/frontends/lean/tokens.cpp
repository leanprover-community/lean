...
static name const * g_ldbracket_tk = nullptr;
static name const * g_rdbracket_tk = nullptr;
...
void initialize_tokens() {
    ...
    g_ldbracket_tk = new name{"⟬"};
    g_rdbracket_tk = new name{"⟭"};
...
void finalize_tokens() {
    ...
    delete g_ldbracket_tk;
    delete g_rdbracket_tk;
...
name const & get_ldbracket_tk() { return *g_ldbracket_tk; }
name const & get_rdbracket_tk() { return *g_rdbracket_tk; }
